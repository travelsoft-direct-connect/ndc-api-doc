...
WSDL and XSD files can be downloaded directly [here](/ndc-api-doc/assets/19.2/orchestraNDCService-20192.zip).
...
## Postman Collection
You can dowload the [postman collection](/ndc-api-doc/assets/19.2/Travelsoft_API_NDC_19_2.postman_collection.json) to test during your integration.
...
![Booking flow](/ndc-api-doc/assets/images/19.2/BookingFlow.png "Booking flow")

## Servicing flows

- Get order data for refresh:

![Retrieve flow](/ndc-api-doc/assets/images/19.2/PostBookRetrieveFlow.png "Retrieve flow")

- Ticket issue:

![Ticket issue flow](/ndc-api-doc/assets/images/19.2/PostBookIssueFlow.png "Ticket issue flow")

- Cancellation:

![Cancel flow](/ndc-api-doc/assets/images/19.2/PostBookCancelFlow.png "Cancel flow")
...
Download all message samples [here](/ndc-api-doc/assets/19.2/samples_19_2.zip).
